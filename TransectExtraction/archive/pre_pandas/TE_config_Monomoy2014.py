...
armorLines = 'blankarmor'.format(**SiteYear_strings)
...
CPpts = '{site}{year}_topBeachEdgePts'.format(**SiteYear_strings)                     # MLW points calculated during Beach Width calculation
