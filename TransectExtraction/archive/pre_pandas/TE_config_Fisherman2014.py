...
############ Inputs #########################
SiteYear_strings = {'site': 'Fisherman',
                    'year': '2014',
                    'region': 'Delmarva',
                    'MHW':0.34,
                    'MLW':-0.52, # average of approximate MLW on Chesapeake Bay side (-0.47) and Atlantic side (-0.58)
                    'MTL':None}
...
ShorelinePts = '{site}{year}_SLpts_utm'.format(**SiteYear_strings)
dhPts = '{site}{year}_DHpts_utm'.format(**SiteYear_strings)				# Dune crest
dlPts = '{site}{year}_DLpts_utm'.format(**SiteYear_strings) 		  # Dune toe
