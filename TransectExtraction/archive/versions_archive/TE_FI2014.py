...
### CREATE SHORELINE from SLpts or MHW_oceanside if needed ### MUST BE PROJECTED
# ShorelinePts/MHW_oceanside must be projected to nad83utm18
if CreateMHWline:
    MHW_oceanside = oceanside_auto
    arcpy.PointsToLine_management(ShorelinePts, MHW_oceanside)

if not CreateMHWline and not arcpy.Exists(shoreline):
