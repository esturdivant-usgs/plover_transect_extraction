...
arcpy.env.workspace=home= r'C:/Users/esturdivant/Documents/ArcGIS/BreezyPoint2011_v2.gdb' #   NOTE back slash vs. fore slash
...
# Year-specific
dhPts = 'DuneCrests_BreezyPt2011' 				# Dune crest ***NOTE: replace -99999 values will Null before running!!!
dlPts = 'DuneToe_BreezyPt2011' 				# Dune toe ***NOTE: replace -99999 values will Null before running!!!
# To replace fill values with Null:
...
barrierBoundary = 'BreezyPoint2011Polygon' 	# Barrier Boundary-done
ShorelinePts = 'SLPsBreezyPt2011' 			# Shoreline points, and has slope info.
MHW_oceanside = 'BreezyPt_2011_OceanShore'   # MHW, used to create BreezyBoundsPGon
...
shoreline = 'ShL_JettytoInlet_2011'        # Complete shoreline ready to become route in Pt. 2
baseName = 'trans_clip_working'         # Clipped transects			NOTE: 'StartX' and 'StartY' in code are UTM XYs stored here.
finaltransects = 'BreezyPt_2011_trans_clip2BND'
