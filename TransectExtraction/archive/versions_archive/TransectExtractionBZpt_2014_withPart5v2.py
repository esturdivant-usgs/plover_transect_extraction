...
arcpy.env.workspace=home= r'D:/ben_usgs/stippaData/Breezy2014/BreezyPt2014v3.gdb'
arcpy.env.workspace=home= r"\\Mac\Home\Documents\ArcGIS\Breezy2014v3_ejs.gdb"
##################################### Inputs
...
# Year-specific
year = '2014'
dhPts = 'DuneHigh_BreezyPt2014' 				# Dune crest ***NOTE: replace -99999 values will Null before running!!!
dlPts = 'DuneLow_BreezyPt2014' 				# Dune toe ***NOTE: replace -99999 values will Null before running!!!
barrierBoundary = 'BreezyPt_2014_Polygon' 	# Barrier Boundary polygon
ShorelinePts = 'BreezyPt2014_shoreline' 			# Shoreline points, and has slope info.
MHW_oceanside = 'BreezyPoint_2014_OceanMHW'   # MHW, used to create BreezyBoundsPGon
elevGrid = 'Elev2015_MHW' 				# Elevation
...
transwork = transects + '_' + year
arcpy.CopyFeatures_management(home+'/'+transects,transwork)
transects = transwork
