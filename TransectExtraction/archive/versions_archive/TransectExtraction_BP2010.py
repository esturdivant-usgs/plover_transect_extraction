...
############ Inputs #########################
arcpy.env.workspace=home= r"\\Mac\Home\Documents\ArcGIS\BreezyPt2010.gdb"
output = r"\\Mac\Home\DATA\Output.gdb"
...
deletePtsWithZfill = True
orig_dhPts = 'NY_DuneCrests_2010edited'
orig_dlPts = 'DuneToe_2010edited'

dhPts = site+'_DH_'+year+'_edit2' 				# Dune crest
dlPts = site+'_DL_'+year+'_edit2' 				# Dune toe
ShorelinePts = 'SLPsBreezyPt2010' #site+'_SLPs_'+year 			          # Shoreline points
#lines
MHW_oceanside = 'BreezyPoint2010_OceanShoreline'
OceansideLineTooShortOrLong = 'short'  # 'short', 'long', or False
...
#polygons
barrierBoundary = 'BreezyPoint'+year+'Polygon'   # Barrier Boundary polygon; create with TE_createBoundaryPolygon.py
#grids
elevGrid = 'BP_DEM_2010'				# Elevation
...
def PointsToTransOrder(fc,oldPts,newPts,tempfile='trans_temp',tolerance='25 METERS'):
...
"""
arcpy.MakeTableView_management(transSplitPts_final,transSplitPts_final)
