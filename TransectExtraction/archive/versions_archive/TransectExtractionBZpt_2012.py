...
# Year-specific
year = '2012'
dhPts = 'DuneHigh_BreezyPt2012' 				# Dune crest ***NOTE: replace -99999 values will Null before running!!!
dlPts = 'DuneLow_BreezyPt2012' 				# Dune toe ***NOTE: replace -99999 values will Null before running!!!
barrierBoundary = 'BreezyPt_2012_Polygon' 	# Barrier Boundary-done
ShorelinePts = 'BreezyPt2012_shoreline' 			# Shoreline points, and has slope info.
MHW_oceanside = 'BreezyPoint_2012_OceanMHW'   # MHW, used to create BreezyBoundsPGon
elevGrid = 'BreezyPoint_USACE2012_DEM' 				# Elevation
############################################# Outputs
...
finaltransects = 'BreezyPt_trans_clip_' + year
