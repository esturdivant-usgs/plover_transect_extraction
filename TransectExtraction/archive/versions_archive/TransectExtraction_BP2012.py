...
############ Inputs #########################
arcpy.env.workspace=home= r"\\Mac\Home\Documents\ArcGIS\BreezyPt2012.gdb"

year = '2012'
site = 'BP'

#points
dhPts = site+'_DH_'+year+'_edit2' 				# Dune crest
dlPts = site+'_DL_'+year+'_edit2' 				# Dune toe
fillValuesInPts = True
ShorelinePts = 'BreezyPt2012_shoreline' #site+'_SLPs_'+year 			          # Shoreline points
#lines
MHW_oceanside = site+'_MHWocean_'+year+'_edit1'   # MHW, used to create BreezyBoundsPGon
inletLines = site+'_inletLines'             # manually create lines based on the boundary polygon that correspond to end of land and cross the MHW line
...
#grids
elevGrid = 'BreezyPoint_USACE2012_DEM_5m'				# Elevation
...
#if arcpy.GetRasterProperties_management(elevGrid,'CELLSIZEX').outputCount == 1:
...
arcpy.MakeTableView_management(transSplitPts_final,os.path.join(output,transSplitPts_final+'.xls'))


arcpy.TableToExcel_conversion(transSplitPts_final,os.path.join(output,transSplitPts_final+'.xls'))
