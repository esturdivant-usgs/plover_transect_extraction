...
arcpy.env.workspace=home= r"\\Mac\Home\Documents\ArcGIS\FireIsland_2011.gdb"
############ Inputs #########################
# Year-specific:
year = '2011'
barrierBoundary = 'FI2011_BNDpoly' 	# Barrier Boundary polygon; create with TE_createBoundaryPolygon.py
dhPts = 'NY_10CNT10_dhigh' 					# Dune crest,***NOTE: replace -99999 values will Null before running!!!
dlPts = 'NY_10CNT10_dlow' 						# Dune toe,  ***NOTE: replace -99999 values will Null before running!!!
ShorelinePts = 'NY_10CNT10_shoreline' 			# Shoreline points
MHW_oceanside = 'FireIsland2011_FullShoreline'   # MHW, used to create BreezyBoundsPGon
inletLines = 'FI_inletLines_2011'
...
#  Site-specific:
site = 'FireIsland'
extendedTransects = 'FI_extTransects' # Created MANUALLY: see TransExtv4Notes.txt
