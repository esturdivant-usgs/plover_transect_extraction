...
arcpy.SpatialJoin_analysis(shl2trans,ShorelinePts, 'join_temp','#','#','#',"CLOSEST",pt2trans_disttolerance) # create join_temp
...
if not arcpy.Exists(trans_noOver):
    ...
    arcpy.CopyFeatures_management(trans_noOver, trans_clip_archive)
