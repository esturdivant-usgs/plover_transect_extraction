...
arcpy.env.workspace=home= r"\\Mac\Home\Documents\ArcGIS\FireIsland_2012_v2.gdb"
...
extendedTransects = site+"_extTrans" # Created MANUALLY: see TransExtv4Notes.txt
...
armorLines = site+year+'_nonfencingstructures'
...
rawtransects = False
rawbarrierline = 'FireIsland2012_FullShoreline'
...
finalmessage = "\nNow enter the USER: \n\n" \
      "1. Export the final feature class ("+tranSplitPts+") as Shapefile. \n" \
      "2. Export the new table ("+transSplitPts_final+") as Text with a '.csv' extension. \n" \
...
transPts_ben = '{}{}_trans_5mPtsUpCombinedsubFix_1219'.format(site,year)
