...
out_dir = r'T:\Commons_DeepDive\DeepDive\Virginia\{}\{}\Extracted_Data'.format(site,year)

# Site-specific values
MHW = 0.34
dMHW = -MHW                    # Beach height adjustment
MLW = -0.95						# MLW offset from MHW # Beach height adjustment (relative to MHW)
...
extendedTransects = site+year+"_extTrans" # Created MANUALLY: see TransExtv4Notes.txt
...
MHW_oceanside = site+year+"_MHWocean_utm"
...
barrierBoundary = site+year+'_bndpoly_man'   # Barrier Boundary polygon; create with TE_createBoundaryPolygon.py
elevGrid = site+year+'_DEM'				# Elevation
...
projection_code = 26918
nad83utm18 = arcpy.SpatialReference(projection_code)
